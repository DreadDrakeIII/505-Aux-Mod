...
class RscMineTile
{
	...
	animTextureNormal = "empty.paa";
	animTextureDisabled = "empty.paa";
	animTextureOver = "empty.paa";
	animTextureFocused = "empty.paa";
	animTexturePressed = "empty.paa";
	animTextureDefault = "empty.paa";
};
