class CFGVehicles {
    ...
    class CLASS(Sundevil_A1): OPTRE_M808B2A1 {
        SCOPE_PUBLIC;

        displayName = "[505th] M808B2 A1 Sun Devil";
        faction = QFACTION(505th);
        editorSubcategory = QEDSUBCAT(Anti_Air);
        crew = QCLASS(Marine_Rifleman_CE);
        hiddenSelections[] = {
    ...
    class CLASS(Sundevil_Single): OPTRE_M808B2_Driverless {
        SCOPE_PUBLIC;
    ...
    class CLASS(Sundevil_A1_Single): OPTRE_M808B2A1_Driverless {
        SCOPE_PUBLIC;
