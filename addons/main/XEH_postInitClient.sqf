...
[{
    ...
    if (GVARMAIN(clientVersion) isNotEqualTo GVARMAIN(serverVersion)) then {
        ...
        private _message = "You have a different version of the 505th Aux loaded compared to the server. Either you or the server could be missing important fixes, try repairing the 505th Aux through the Arma launcher to download the latest updates.";
