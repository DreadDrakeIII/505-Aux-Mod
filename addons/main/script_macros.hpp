...
#undef PREP
    ...
    #define PREP_RECOMPILE_START    if (isNil "505aux_fnc_recompile") then {505aux_recompiles = []; 505aux_fnc_recompile = {{call _x} forEach 505aux_recompiles;}}; private _recomp = {
    #define PREP_RECOMPILE_END      }; call _recomp; 505aux_recompiles pushBack _recomp;
#else
