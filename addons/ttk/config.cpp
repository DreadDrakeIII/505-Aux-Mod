...
class CfgFunctions {
    class OLI {
        tag = "OLI";
        class Biofoam {
            file = "\BLU\OLI\addons\ttk\functions\biofoam";
            class canBiofoam {};
            class treatBiofoam {};
            class biofoamLocal {};
        };
        class TacticalTraumaKit {
            file = "\BLU\OLI\addons\ttk\functions\tactical_trauma_kit";
            class canTTK {};
            class treatTTK {};
            class ttkLocal {};
            class getTTKTime {};
        ...
        class BonePolyseal {
            file = "\BLU\OLI\addons\ttk\functions\bone_polyseal";
            class treatPolyseal {};
            class polysealLocal {};
            class polysealApply {};
        };
        class NecroClear {
            file = "\BLU\OLI\addons\ttk\functions\necroclear";
            class canNecroClear {};
        ...
        class Endurex {
            file = "\BLU\OLI\addons\ttk\functions\endurex";
            class canEndurex {};
            class treatEndurex {};
            class endurexLocal {};
            class endurexStop {};
        ...
        class CombatStim {
            file = "\BLU\OLI\addons\ttk\functions\combat_stim";
            class canFlatline {};
            class treatFlatline {};
            class flatlineLocal {};
            class flatlineStop {};
        ...
        class GUI {
            file = "\BLU\OLI\addons\ttk\functions\gui";
            class updateBodyImage {};
        };
        class Common {
            file = "\BLU\OLI\addons\ttk\functions\common";
...
class ACE_Medical_Treatment_Actions {
    ...
    class EndurexBoosterInhaler: Painkillers {
        ...
        litter[] = {};
        sounds[] = {{"\BLU\OLI\addons\ttk\sounds\endurex01.ogg", 0, 1, 1}};
    };
