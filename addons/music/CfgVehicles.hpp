class CfgVehicles {
    ...
    SOUND_OBJ(Bustling_Town_Ambience,"[505th] Town Ambience");
    SOUND_OBJ(Star_Trek_RED_ALERT,"[505th] Red Alert");
    SOUND_OBJ(Self_Destruct_Sequence_30_sec,"[505th] Self Destruct");
    SOUND_OBJ(Insurrection_Begins_Today_1,"[505th] Insurrection Begins 1");
    ...
    SOUND_OBJ(Journey_To_Rome,"[505th] Journey to Rome");
};
