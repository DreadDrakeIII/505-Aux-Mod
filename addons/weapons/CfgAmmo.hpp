class CfgAmmo {
    ...
    class CLASS(762x51_Ball): B_762x51_Ball {
        author = AUTHOR;
        displayName = "[505th] 7.62x51mm Ball";
        descriptionShort = "Standard Ball round • 7.62×51mm";
    ...
    //     author = AUTHOR;
    //     displayName = "[505th] 9.5x40mm Ball";
    //     descriptionShort = "Standard Ball round • 9.5x40mm";
    ...
    //     author            = AUTHOR;
    //     displayName       = "[505th] 7.62xV7 Ball";
    //     descriptionShort  = "Standard Ball round • 7.62×V7 • BMR load";
    //     cartridge = "FxCartridge_762";
    ...
    //     author           = AUTHOR;
    //     displayName      = "[505th] 9.5×VX2 Ball";
    //     descriptionShort = "High-penetration, long-range round • 9.5×VX2";
