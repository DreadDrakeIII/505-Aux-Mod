class CfgMagazines {
    ...
    // ================================
    class CLASS(5Rnd_147x114_APFSDS_Magv2) : TCP_4Rnd_127x99_Mag_APFSDS_Tracer_Green {
        SCOPE_PUBLIC;
        baseMagazine = QCLASS(5Rnd_147x114_APFSDS_Magv2);
        author = AUTHOR;
    ...
    // ================================
    class CLASS(5Rnd_147x114_HVAP_Magv2): CLASS(5Rnd_147x114_APFSDS_Magv2) {
    ...
    // ================================
    class CLASS(5Rnd_147x114_HEDP_Magv2): CLASS(5Rnd_147x114_APFSDS_Magv2) {
