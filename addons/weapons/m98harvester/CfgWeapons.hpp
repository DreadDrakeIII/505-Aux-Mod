...
class CfgWeapons {
    ...
    // ================================
    class CLASS(M98_HARVESTER): TCP_srifle_SRS99 {
        SCOPE_PUBLIC;
        author = AUTHOR;
        ...
        descriptionShort = "M98 Harvester is an upgraded version of the M98 Harvester developed by Blackreach Armory Industries.";
        ...
        reloadMagazineSound[] = {"\BLU\OLI\addons\weapons\m98harvester\data\sound\m98h_reload.ogg",1,1};
